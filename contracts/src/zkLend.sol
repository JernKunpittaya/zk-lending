...
contract zkLend is MerkleTreeWithHistory, ReentrancyGuard {
    ...
    function constructPublicInputs(
        ...
        public_inputs[3] = _old_nullifier;
        public_inputs[4] = _root;
        public_inputs[5] = bytes32(liquidated_array[0].liq_price);
        public_inputs[6] = bytes32(liquidated_array[0].timestamp);
        public_inputs[7] = bytes32(liquidated_array[1].liq_price);
        public_inputs[8] = bytes32(liquidated_array[1].timestamp);
        public_inputs[9] = bytes32(liquidated_array[2].liq_price);
        public_inputs[10] = bytes32(liquidated_array[2].timestamp);
        public_inputs[11] = bytes32(liquidated_array[3].liq_price);
        public_inputs[12] = bytes32(liquidated_array[3].timestamp);
        public_inputs[13] = bytes32(liquidated_array[4].liq_price);
        public_inputs[14] = bytes32(liquidated_array[4].timestamp);
        public_inputs[15] = bytes32(liquidated_array[5].liq_price);
        public_inputs[16] = bytes32(liquidated_array[5].timestamp);
        public_inputs[17] = bytes32(liquidated_array[6].liq_price);
        public_inputs[18] = bytes32(liquidated_array[6].timestamp);
        public_inputs[19] = bytes32(liquidated_array[7].liq_price);
        public_inputs[20] = bytes32(liquidated_array[7].timestamp);
        public_inputs[21] = bytes32(liquidated_array[8].liq_price);
        public_inputs[22] = bytes32(liquidated_array[8].timestamp);
        public_inputs[23] = bytes32(liquidated_array[9].liq_price);
        public_inputs[24] = bytes32(liquidated_array[9].timestamp);
